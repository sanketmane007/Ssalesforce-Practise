import { LightningElement,wire,track } from 'lwc';
 ...
 const COLS=[ {label:'Name',fieldName:'Name', type:'text'}, {label:'Stage',fieldName:'StageName', type:'text'}, {label:'Amount',fieldName:'Amount', type:'currency'}]; 
...
export default class DataTableInLWC extends LightningElement {
 ...
 deleteRecord(){
 var selectedRecords =
 this.template.querySelector("lightningdatatable").getSelectedRows();
